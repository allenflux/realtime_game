CREATE TABLE `retry_refund_task` (
...
) ENGINE = InnoDB AUTO_INCREMENT = 17830 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC COMMENT = '取消注单失败需要重试的任务表'